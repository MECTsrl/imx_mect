...
URL_LTIB_EVKARCH = $(FTPURL)/$(LTIB_EVKARCH)
URL_LTIB_EVKARCH_MD5 = $(FTPURL)/$(LTIB_EVKARCH).$(MD5EXT)
...
URL_LTIBINST_TARGETDIR_PATHCH = $(FTPURL)/$(LTIBINST_TARGETDIR_PATHCH)
URL_LTIBINST_TARGETDIR_PATHCH_MD5 = $(FTPURL)/$(LTIBINST_TARGETDIR_PATHCH).$(MD5EXT)

# LTIB fix downloads for Ubuntu 12.04 (MECT patch)
LTIB_UBUNTU_URL_PATHCH = ltib-ubuntu12.04-url.patch
URL_LTIB_PATCH_HTTPS_PATHCH = $(FTPURL)/$(LTIB_UBUNTU_URL_PATHCH)
URL_LTIB_PATCH_HTTPS_PATHCH_MD5 = $(FTPURL)/$(LTIB_UBUNTU_URL_PATHCH).$(MD5EXT)

# LTIB set configuration (MECT patch)
LTIB_CONFIG_PATCH = ltib-config.patch
URL_LTIB_CONFIG_PATCH = $(FTPURL)/$(LTIB_CONFIG_PATCH)
URL_LTIB_CONFIG_PATCH_MD5 = $(FTPURL)/$(LTIB_CONFIG_PATCH).$(MD5EXT)

# LTIB fix deprecated warning and missing zlib (MECT patch)
LTIB_DEPR_AND_ZLIB_PATCH = ltib-deprecated+zlib.patch
URL_LTIB_DEPR_AND_ZLIB_PATCH = $(FTPURL)/$(LTIB_DEPR_AND_ZLIB_PATCH)
URL_LTIB_DEPR_AND_ZLIB_PATCH_MD5 = $(FTPURL)/$(LTIB_DEPR_AND_ZLIB_PATCH).$(MD5EXT)

# LTIB rpm-fs spec file (MECT patch)
LTIB_RPM_FS_SPEC_PATCH = rpm-fs-mect-spec.patch
URL_LTIB_RPM_FS_SPEC_PATCH = $(FTPURL)/$(LTIB_RPM_FS_SPEC_PATCH)
URL_LTIB_RPM_FS_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_RPM_FS_SPEC_PATCH).$(MD5EXT)

# LTIB bison spec file (MECT patch)
LTIB_BISON_SPEC_PATCH = bison-mect-spec.patch
URL_LTIB_BISON_SPEC_PATCH = $(FTPURL)/$(LTIB_BISON_SPEC_PATCH)
URL_LTIB_BISON_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_BISON_SPEC_PATCH).$(MD5EXT)

# LTIB texinfo spec file (MECT patch)
LTIB_TEXINFO_SPEC_PATCH = texinfo-mect-spec.patch
URL_LTIB_TEXINFO_SPEC_PATCH = $(FTPURL)/$(LTIB_TEXINFO_SPEC_PATCH)
URL_LTIB_TEXINFO_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_TEXINFO_SPEC_PATCH).$(MD5EXT)

# LTIB pkgconfig spec file (MECT patch)
LTIB_PKGCONFIG_SPEC_PATCH = pkgconfig-mect-spec.patch
URL_LTIB_PKGCONFIG_SPEC_PATCH = $(FTPURL)/$(LTIB_PKGCONFIG_SPEC_PATCH)
URL_LTIB_PKGCONFIG_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_PKGCONFIG_SPEC_PATCH).$(MD5EXT)

# LTIB sparse spec file (MECT patch)
LTIB_SPARSE_SPEC_PATCH = sparse-mect-spec.patch
URL_LTIB_SPARSE_SPEC_PATCH = $(FTPURL)/$(LTIB_SPARSE_SPEC_PATCH)
URL_LTIB_SPARSE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_SPARSE_SPEC_PATCH).$(MD5EXT)

# LTIB git spec file (MECT patch)
LTIB_GIT_SPEC_PATCH = git-mect-spec.patch
URL_LTIB_GIT_SPEC_PATCH = $(FTPURL)/$(LTIB_GIT_SPEC_PATCH)
URL_LTIB_GIT_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_GIT_SPEC_PATCH).$(MD5EXT)

# LTIB fix u-boot build (MECT patch)
LTIB_U_BOOT_SPEC_PATCH = u-boot-spec-patch-link-fix-1418123257.patch
URL_LTIB_U_BOOT_SPEC_PATCH = $(FTPURL)/$(LTIB_U_BOOT_SPEC_PATCH)
URL_LTIB_U_BOOT_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_U_BOOT_SPEC_PATCH).$(MD5EXT)
LTIB_U_BOOT_TEMPLATE_SPEC_PATCH = u-boot-2.6.35_1.1.0-spec-template-mect.patch
URL_LTIB_U_BOOT_TEMPLATE_SPEC_PATCH = $(FTPURL)/$(LTIB_U_BOOT_TEMPLATE_SPEC_PATCH)
URL_LTIB_U_BOOT_TEMPLATE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_U_BOOT_TEMPLATE_SPEC_PATCH).$(MD5EXT)

# LTIB fix configuration merge into root file system (MECT patch)
LTIB_MERGE_PATCH = merge-mect-spec.patch
URL_LTIB_MERGE_PATCH = $(FTPURL)/$(LTIB_MERGE_PATCH)
URL_LTIB_MERGE_PATCH_MD5 = $(FTPURL)/$(LTIB_MERGE_PATCH).$(MD5EXT)
...
URL_LTIB_KERNEL_SPEC_PATCH = $(FTPURL)/$(LTIB_KERNEL_SPEC_PATCH)
URL_LTIB_KERNEL_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_KERNEL_SPEC_PATCH).$(MD5EXT)
LTIB_KERNEL_TEMPLATE_SPEC_PATCH = kernel-2.6.35-spec-template-mect.patch
URL_LTIB_KERNEL_TEMPLATE_SPEC_PATCH = $(FTPURL)/$(LTIB_KERNEL_TEMPLATE_SPEC_PATCH)
URL_LTIB_KERNEL_TEMPLATE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_KERNEL_TEMPLATE_SPEC_PATCH).$(MD5EXT)

# LTIB set MECT PPP (MECT patch)
LTIB_MECT_PPP_PATCH = ltib-mect-ppp-url.patch
URL_LTIB_MECT_PPP_PATCH = $(FTPURL)/$(LTIB_MECT_PPP_PATCH)
URL_LTIB_MECT_PPP_PATCH_MD5 = $(FTPURL)/$(LTIB_MECT_PPP_PATCH).$(MD5EXT)

# LTIB Ubuntu 12.04 patch bundle
LTIB_UBUNTU_12_04_PATCH = patch-ltib-ubuntu12.04.sh
ifndef $(USE_PPP_TMP_LOC)
URL_LTIB_UBUNTU_12_04_PATCH = $(FTPURL)/$(LTIB_UBUNTU_12_04_PATCH)
else
URL_LTIB_UBUNTU_12_04_PATCH = https://community.freescale.com/servlet/JiveServlet/downloadBody/93455-102-2-2825/$(LTIB_UBUNTU_12_04_PATCH)
endif
URL_LTIB_UBUNTU_12_04_PATCH_MD5 = $(FTPURL)/$(LTIB_UBUNTU_12_04_PATCH).$(MD5EXT)
...
URL_LTIB_ELFTOSB_SPEC_PATCH = $(FTPURL)/$(LTIB_ELFTOSB_SPEC_PATCH)
URL_LTIB_ELFTOSB_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_ELFTOSB_SPEC_PATCH).$(MD5EXT)

# SFTP server
LTIB_SFTP_SERVER_SPEC_PATCH = sftp-server-mect-spec.patch
URL_LTIB_SFTP_SERVER_SPEC = $(FTPURL)/$(LTIB_SFTP_SERVER_SPEC_PATCH)
URL_LTIB_SFTP_SERVER_SPEC_MD5 = $(FTPURL)/$(LTIB_SFTP_SERVER_SPEC_PATCH).$(MD5EXT)

# libsocketcan
LTIB_LIBSOCKETCAN_SPEC_PATCH = libsocketcan-mect-spec.patch
URL_LTIB_LIBSOCKETCAN_SPEC = $(FTPURL)/$(LTIB_LIBSOCKETCAN_SPEC_PATCH)
URL_LTIB_LIBSOCKETCAN_SPEC_MD5 = $(FTPURL)/$(LTIB_LIBSOCKETCAN_SPEC_PATCH).$(MD5EXT)

# qwt
QWT_VERSION = 6.1.0
LTIB_QWT_SPEC_PATCH = qwt-mect-$(QWT_VERSION)-spec.patch
URL_LTIB_QWT_SPEC = $(FTPURL)/$(LTIB_QWT_SPEC_PATCH)
URL_LTIB_QWT_SPEC_MD5 = $(FTPURL)/$(LTIB_QWT_SPEC_PATCH).$(MD5EXT)

# LTIB fix boot_stream spec (MECT patch)
LTIB_BOOT_STREAM_SPEC_PATCH = boot_stream-mect-spec.patch
URL_LTIB_BOOT_STREAM_SPEC_PATCH = $(FTPURL)/$(LTIB_BOOT_STREAM_SPEC_PATCH)
URL_LTIB_BOOT_STREAM_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_BOOT_STREAM_SPEC_PATCH).$(MD5EXT)

# LTIB MECT patch to fix linking of base_libs
LTIB_BASE_LIBS_SPEC_PATCH = base_libs-mect-spec.patch
URL_LTIB_BASE_LIBS_SPEC_PATCH = $(FTPURL)/$(LTIB_BASE_LIBS_SPEC_PATCH)
URL_LTIB_BASE_LIBS_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_BASE_LIBS_SPEC_PATCH).$(MD5EXT)

# LTIB boa spec file (MECT patch)
LTIB_BOA_SPEC_PATCH = boa-mect-spec.patch
URL_LTIB_BOA_SPEC_PATCH = $(FTPURL)/$(LTIB_BOA_SPEC_PATCH)
URL_LTIB_BOA_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_BOA_SPEC_PATCH).$(MD5EXT)

# LTIB qt spec file (MECT patch)
QT_INSTALL_DIR = /opt/Trolltech
QT_VERSION = 4.8.5
LTIB_QT_SPEC_PATCH = qt-embedded-mect-$(QT_VERSION)-spec.patch
URL_LTIB_QT_SPEC_PATCH = $(FTPURL)/$(LTIB_QT_SPEC_PATCH)
URL_LTIB_QT_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_QT_SPEC_PATCH).$(MD5EXT)
LTIB_QT_ARCH = qt-everywhere-opensource-src-$(QT_VERSION).tar.gz
URL_LTIB_QT_ARCH = $(FTPURL)/$(LTIB_QT_ARCH)
URL_LTIB_QT_ARCH_MD5 = $(FTPURL)/$(LTIB_QT_ARCH).$(MD5EXT)
LTIB_QT_PATCH1 = qt-everywhere-opensource-src-$(QT_VERSION)-1394522957.patch
URL_LTIB_QT_PATCH1 = $(FTPURL)/$(LTIB_QT_PATCH1)
URL_LTIB_QT_PATCH1_MD5 = $(FTPURL)/$(LTIB_QT_PATCH1).$(MD5EXT)
LTIB_QT_PATCH2 = qt-everywhere-opensource-src-$(QT_VERSION)-1420823826.patch
URL_LTIB_QT_PATCH2 = $(FTPURL)/$(LTIB_QT_PATCH2)
URL_LTIB_QT_PATCH2_MD5 = $(FTPURL)/$(LTIB_QT_PATCH2).$(MD5EXT)
LTIB_QT_PATCH3 = qt-everywhere-opensource-src-$(QT_VERSION)-1420823825.patch
URL_LTIB_QT_PATCH3 = $(FTPURL)/$(LTIB_QT_PATCH3)
URL_LTIB_QT_PATCH3_MD5 = $(FTPURL)/$(LTIB_QT_PATCH3).$(MD5EXT)

# LTIB iproute spec file (MECT patch)
LTIB_IPROUTE_SPEC_PATCH = iproute-mect-spec.patch
URL_LTIB_IPROUTE_SPEC_PATCH = $(FTPURL)/$(LTIB_IPROUTE_SPEC_PATCH)
URL_LTIB_IPROUTE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_IPROUTE_SPEC_PATCH).$(MD5EXT)

# LTIB skell spec file (MECT patch)
LTIB_SKELL_SPEC_PATCH = skell-mect-spec.patch
URL_LTIB_SKELL_SPEC_PATCH = $(FTPURL)/$(LTIB_SKELL_SPEC_PATCH)
URL_LTIB_SKELL_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_SKELL_SPEC_PATCH).$(MD5EXT)

# LTIB sysconfig spec file (MECT patch)
LTIB_SYSCONFIG_SPEC_PATCH = sysconfig-mx-mect-spec.patch
URL_LTIB_SYSCONFIG_SPEC_PATCH = $(FTPURL)/$(LTIB_SYSCONFIG_SPEC_PATCH)
URL_LTIB_SYSCONFIG_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_SYSCONFIG_SPEC_PATCH).$(MD5EXT)

# LTIB xenomai spec file (MECT patch)
LTIB_XENOMAI_SPEC_PATCH = xenomai-mect-spec.patch
URL_LTIB_ZIP30_SPEC = $(FTPURL)/$(LTIB_XENOMAI_SPEC_PATCH)
URL_LTIB_ZIP30_SPEC_MD5 = $(FTPURL)/$(LTIB_XENOMAI_SPEC_PATCH).$(MD5EXT)

# LTIB zip30 spec file (MECT patch)
LTIB_ZIP30_SPEC_PATCH = zip30-mect-spec.patch
URL_LTIB_ZIP30_SPEC = $(FTPURL)/$(LTIB_ZIP30_SPEC_PATCH)
URL_LTIB_ZIP30_SPEC_MD5 = $(FTPURL)/$(LTIB_ZIP30_SPEC_PATCH).$(MD5EXT)

# LTIB busybox spec file (MECT patch)
LTIB_BUSYBOX_SPEC_PATCH = busybox-mect-spec.patch
URL_LTIB_BUSYBOX_SPEC_PATCH = $(FTPURL)/$(LTIB_BUSYBOX_SPEC_PATCH)
URL_LTIB_BUSYBOX_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_BUSYBOX_SPEC_PATCH).$(MD5EXT)

# LTIB bzip2 spec file (MECT patch)
LTIB_BZIP2_SPEC_PATCH = bzip2-mect-spec.patch
URL_LTIB_BZIP2_SPEC_PATCH = $(FTPURL)/$(LTIB_BZIP2_SPEC_PATCH)
URL_LTIB_BZIP2_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_BZIP2_SPEC_PATCH).$(MD5EXT)

# LTIB cantest spec file (MECT patch)
LTIB_CANTEST_SPEC_PATCH = cantest-mect-spec.patch
URL_LTIB_CANTEST_SPEC_PATCH = $(FTPURL)/$(LTIB_CANTEST_SPEC_PATCH)
URL_LTIB_CANTEST_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_CANTEST_SPEC_PATCH).$(MD5EXT)

# LTIB dhcp spec file (MECT patch)
LTIB_DHCP_SPEC_PATCH = dhcp-mect-spec.patch
URL_LTIB_DHCP_SPEC_PATCH = $(FTPURL)/$(LTIB_DHCP_SPEC_PATCH)
URL_LTIB_DHCP_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_DHCP_SPEC_PATCH).$(MD5EXT)

# LTIB dropbear spec file (MECT patch)
LTIB_DROPBEAR_SPEC_PATCH = dropbear-mect-spec.patch
URL_LTIB_DROPBEAR_SPEC_PATCH = $(FTPURL)/$(LTIB_DROPBEAR_SPEC_PATCH)
URL_LTIB_DROPBEAR_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_DROPBEAR_SPEC_PATCH).$(MD5EXT)

# LTIB e2fsprogs spec file (MECT patch)
LTIB_E2FSPROGS_SPEC_PATCH = e2fsprogs-mect-spec.patch
URL_LTIB_E2FSPROGS_SPEC_PATCH = $(FTPURL)/$(LTIB_E2FSPROGS_SPEC_PATCH)
URL_LTIB_E2FSPROGS_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_E2FSPROGS_SPEC_PATCH).$(MD5EXT)

# LTIB expat spec file (MECT patch)
LTIB_EXPAT_SPEC_PATCH = expat-mect-spec.patch
URL_LTIB_EXPAT_SPEC_PATCH = $(FTPURL)/$(LTIB_EXPAT_SPEC_PATCH)
URL_LTIB_EXPAT_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_EXPAT_SPEC_PATCH).$(MD5EXT)

# LTIB fake-provides spec file (MECT patch)
LTIB_FAKE_SPEC_PATCH = fake-provides-mect-spec.patch
URL_LTIB_FAKE_SPEC_PATCH = $(FTPURL)/$(LTIB_FAKE_SPEC_PATCH)
URL_LTIB_FAKE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_FAKE_SPEC_PATCH).$(MD5EXT)

# LTIB fontconfig spec file (MECT patch)
LTIB_FONTCONFIG_SPEC_PATCH = fontconfig-mect-spec.patch
URL_LTIB_FONTCONFIG_SPEC_PATCH = $(FTPURL)/$(LTIB_FONTCONFIG_SPEC_PATCH)
URL_LTIB_FONTCONFIG_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_FONTCONFIG_SPEC_PATCH).$(MD5EXT)

# LTIB freetype spec file (MECT patch)
LTIB_FREETYPE_SPEC_PATCH = freetype-mect-spec.patch
URL_LTIB_FREETYPE_SPEC_PATCH = $(FTPURL)/$(LTIB_FREETYPE_SPEC_PATCH)
URL_LTIB_FREETYPE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_FREETYPE_SPEC_PATCH).$(MD5EXT)

# LTIB glib2 spec file (MECT patch)
LTIB_GLIB2_SPEC_PATCH = glib2-mect-spec.patch
URL_LTIB_GLIB2_SPEC_PATCH = $(FTPURL)/$(LTIB_GLIB2_SPEC_PATCH)
URL_LTIB_GLIB2_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_GLIB2_SPEC_PATCH).$(MD5EXT)

# LTIB hotplug spec file (MECT patch)
LTIB_HOTPLUG_SPEC_PATCH = hotplug-mect-spec.patch
URL_LTIB_HOTPLUG_SPEC_PATCH = $(FTPURL)/$(LTIB_HOTPLUG_SPEC_PATCH)
URL_LTIB_HOTPLUG_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_HOTPLUG_SPEC_PATCH).$(MD5EXT)

# LTIB imx spec file (MECT patch)
LTIB_IMX_SPEC_PATCH = imx-test-mect-spec.patch
URL_LTIB_IMX_SPEC_PATCH = $(FTPURL)/$(LTIB_IMX_SPEC_PATCH)
URL_LTIB_IMX_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_IMX_SPEC_PATCH).$(MD5EXT)

# LTIB libtermcap spec file (MECT patch)
LTIB_LIBTERMCAP_SPEC_PATCH = libtermcap-mect-spec.patch
URL_LTIB_LIBTERMCAP_SPEC_PATCH = $(FTPURL)/$(LTIB_LIBTERMCAP_SPEC_PATCH)
URL_LTIB_LIBTERMCAP_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_LIBTERMCAP_SPEC_PATCH).$(MD5EXT)

# LTIB libusb spec file (MECT patch)
LTIB_LIBUSB_SPEC_PATCH = libusb-mect-spec.patch
URL_LTIB_LIBUSB_SPEC_PATCH = $(FTPURL)/$(LTIB_LIBUSB_SPEC_PATCH)
URL_LTIB_LIBUSB_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_LIBUSB_SPEC_PATCH).$(MD5EXT)

# LTIB lzo spec file (MECT patch)
LTIB_LZO_SPEC_PATCH = lzo-mect-spec.patch
URL_LTIB_LZO_SPEC_PATCH = $(FTPURL)/$(LTIB_LZO_SPEC_PATCH)
URL_LTIB_LZO_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_LZO_SPEC_PATCH).$(MD5EXT)

# LTIB modeps spec file (MECT patch)
LTIB_MODEPS_SPEC_PATCH = modeps-mect-spec.patch
URL_LTIB_MODEPS_SPEC_PATCH = $(FTPURL)/$(LTIB_MODEPS_SPEC_PATCH)
URL_LTIB_MODEPS_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_MODEPS_SPEC_PATCH).$(MD5EXT)

# LTIB mtd spec file (MECT patch)
LTIB_MTD_SPEC_PATCH = mtd-utils-mect-spec.patch
URL_LTIB_MTD_SPEC_PATCH = $(FTPURL)/$(LTIB_MTD_SPEC_PATCH)
URL_LTIB_MTD_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_MTD_SPEC_PATCH).$(MD5EXT)

# LTIB mysql spec file (MECT patch)
LTIB_MYSQL_SPEC_PATCH = mysql-mect-spec.patch
URL_LTIB_MYSQL_SPEC_PATCH = $(FTPURL)/$(LTIB_MYSQL_SPEC_PATCH)
URL_LTIB_MYSQL_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_MYSQL_SPEC_PATCH).$(MD5EXT)

# LTIB ncurses spec file (MECT patch)
LTIB_NCURSES_SPEC_PATCH = ncurses-mect-spec.patch
URL_LTIB_NCURSES_SPEC_PATCH = $(FTPURL)/$(LTIB_NCURSES_SPEC_PATCH)
URL_LTIB_NCURSES_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_NCURSES_SPEC_PATCH).$(MD5EXT)

# LTIB ppp spec file (MECT patch)
LTIB_PPP_SPEC_PATCH = ppp-mect-spec.patch
URL_LTIB_PPP_SPEC_PATCH = $(FTPURL)/$(LTIB_PPP_SPEC_PATCH)
URL_LTIB_PPP_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_PPP_SPEC_PATCH).$(MD5EXT)

# LTIB rsync spec file (MECT patch)
LTIB_RSYNC_SPEC_PATCH = rsync-mect-spec.patch
URL_LTIB_RSYNC_SPEC_PATCH = $(FTPURL)/$(LTIB_RSYNC_SPEC_PATCH)
URL_LTIB_RSYNC_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_RSYNC_SPEC_PATCH).$(MD5EXT)

# LTIB sqlite spec file (MECT patch)
LTIB_SQLITE_SPEC_PATCH = sqlite-mect-spec.patch
URL_LTIB_SQLITE_SPEC_PATCH = $(FTPURL)/$(LTIB_SQLITE_SPEC_PATCH)
URL_LTIB_SQLITE_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_SQLITE_SPEC_PATCH).$(MD5EXT)

# LTIB tslib spec file (MECT patch)
LTIB_TSLIB_SPEC_PATCH = tslib-mect-spec.patch
URL_LTIB_TSLIB_SPEC_PATCH = $(FTPURL)/$(LTIB_TSLIB_SPEC_PATCH)
URL_LTIB_TSLIB_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_TSLIB_SPEC_PATCH).$(MD5EXT)

# LTIB udev spec file (MECT patch)
LTIB_UDEV_SPEC_PATCH = udev-mect-spec.patch
URL_LTIB_UDEV_SPEC_PATCH = $(FTPURL)/$(LTIB_UDEV_SPEC_PATCH)
URL_LTIB_UDEV_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_UDEV_SPEC_PATCH).$(MD5EXT)

# LTIB unzip spec file (MECT patch)
LTIB_UNZIP_SPEC_PATCH = unzip-mect-spec.patch
URL_LTIB_UNZIP_SPEC_PATCH = $(FTPURL)/$(LTIB_UNZIP_SPEC_PATCH)
URL_LTIB_UNZIP_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_UNZIP_SPEC_PATCH).$(MD5EXT)

# LTIB zlib spec file (MECT patch)
LTIB_ZLIB_SPEC_PATCH = zlib-mect-spec.patch
URL_LTIB_ZLIB_SPEC_PATCH = $(FTPURL)/$(LTIB_ZLIB_SPEC_PATCH)
URL_LTIB_ZLIB_SPEC_PATCH_MD5 = $(FTPURL)/$(LTIB_ZLIB_SPEC_PATCH).$(MD5EXT)
...
env:
	...
	cd /usr/include; sudo ln -sf i386-linux-gnu/sys sys

# Initial downloads (toolchain, LTIB, LTIB patches, ...)
.PHONY: downloads
...
downloads_fc:
	for f in "" $(DOWNLOADS); do \
	    test -z "$$f" && continue; \
	    rm -f $$f.$(MD5EXT); \
	done; exit 0		# Don't break the build if the list is empty.
...
# Set up host Qt.
.PHONY: qt ltib ltibinst ltibpatch ltibbuild clean upload
qt:
