...
MECT_BUILD_ATCMCRT_TAG := v0.3

MECT_BUILD_PLUGINSCRT_BRANCH := mect_suite_2.0
MECT_BUILD_PLUGINSCRT_TAG := v7.0rc1bis
...
#MECT_DEFAULT_IMAGE := TPAC1008_800x600
...
MECT_BUILD_TARGET_TPAC1008_800x600 := TPAC1008_800x600
...
MECT_COMMON_RFSPKGS := \
	...
	mect_plugins-rfs-1.0-$(MECT_BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
...
MECT_LFSPKGS := \
	local-1.0-1_$(BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
	local-ATCMcontrol_RunTimeSystem-1.0-1_$(BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
	local-cgic_work-1.0-1_$(BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
	local-factory_data-1.0-1_$(BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
	local-setup_time-1.0-1_$(BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
	local-splash-1.0-1_$(BUILD_RELEASE).$(MECT_TARGET_ARCH).rpm \
...
TPAC1006_IP112_320x240%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1006_IP112_320x240_r$(BUILD_RELEASE)
...
TPAC1006_IP118_320x240%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1006_IP118_320x240_r$(BUILD_RELEASE)
...
TPAC1006_320x240%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1006_320x240_r$(BUILD_RELEASE)
...
TPAC1006_IP119_640x480%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1006_IP119_640x480_r$(BUILD_RELEASE)
...
TPAC1006_640x480%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1006_640x480_r$(BUILD_RELEASE)
...
TPAC1007_IP113_480x272%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1007_IP113_480x272_r$(BUILD_RELEASE)
...
TPAC1007_IP114_480x272%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1007_IP114_480x272_r$(BUILD_RELEASE)
...
TPAC1007_IP120_480x272%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1007_IP120_480x272_r$(BUILD_RELEASE)
...
TPAC1007_480x272%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1007_480x272_r$(BUILD_RELEASE)
...
TPAC1008_IP208_800x600%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1008_IP208_800x600_r$(BUILD_RELEASE)
...
TPAC1008_IP208_800x600_rfs:
	$(MAKE) BUILD_TARGET='$(MECT_BUILD_TARGET_TPAC1008_800x600)' MECT_RFSDIR='$(MECT_RFSDIR)' MECT_SUFFIX='$(MECT_SUFFIX)' MECT_KERNEL_TARGET_CONF='$(MECT_KERNEL_TARGET_CONF)' MECT_KERNELRPM='$(MECT_KERNELRPM)' MECT_RFSDIR='$(MECT_RFSDIR)' target_rfs
...
TPAC1008_800x600%: MECT_TGTDIR := $(MECT_IMGDIR)/TPAC1008_800x600_r$(BUILD_RELEASE)
