...
Patch4          : vsftpd-2.0.5-mect-rc-conf.patch
BuildRoot       : %{_tmppath}/%{name}
Prefix          : %{pfx}

# vsftpd-2.0.5-mect-rc-conf.patch start the vsftpd at power on from the rc.conf config file
...
for i in usr/sbin etc usr/share/man/man8 usr/share/man/man5 etc/xinetd.d etc/rc.d/init.d usr/share/nobody usr/share/empty
do
...
cp -a rc.d/init.d/vsftpd $RPM_BUILD_ROOT/%{pfx}/etc/rc.d/init.d/vsftpd
chmod +x $RPM_BUILD_ROOT/%{pfx}/etc/rc.d/init.d/vsftpd
