...
%Build
make ARCH=${LINTARCH} CROSS_COMPILE= LINUXSRC=../linux-2.6.10 PLATFORM=${PLATFORM}
...
%Clean
make ARCH=${LINTARCH} CROSS_COMPILE= PLATFORM=${PLATFORM} LINUXSRC=../linux-2.6.10 clean
rm -rf $RPM_BUILD_ROOT
