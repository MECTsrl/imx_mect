...
Patch0          : %{name}-4.5.14-syscall_eabi.patch
Patch1          : %{name}-fix-arm-bad-syscall.patch
Patch2          : %{name}-4.5.14-glibc_2.5-1.patch
Patch3          : %{name}-4.5.14-kernel_headers_2.6.18-1.patch          
Patch4          : %{name}-4.4.98-1155222257.patch
Patch5          : %{name}-4.5.14-linux-dirent.patch
Patch6          : %{name}-4.5.14-fix-build-error-in-gcc-4.6.3.patch
