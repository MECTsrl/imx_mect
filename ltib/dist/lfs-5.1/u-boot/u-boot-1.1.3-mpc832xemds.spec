...
Patch3          : u-boot-1.1.3-mpc832x-board-6.patch
Patch4          : u-boot-1.1.3-Fix-make-3.81-2.patch
Patch5          : u-boot-1.1.3-gcc4-1.patch
Patch6          : u-boot-1.1.3-mpc832x-rodata-str-1.patch
...
%Build
PKG_U_BOOT_CONFIG_TYPE=${PKG_U_BOOT_CONFIG_TYPE:-MPC832XEPB_config}
