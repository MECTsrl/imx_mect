...
Patch1		: u-boot-fsl-1.2.0-POLL_DQ7_STATUS-2.patch
Patch2		: u-boot-fsl-1.2.0-FSL_PCIe_reset.patch
Patch3		: u-boot-fsl-1.2.0-MPC8572DS_BOARD-2.patch
...
%Build
PKG_U_BOOT_CONFIG_TYPE=${PKG_U_BOOT_CONFIG_TYPE:-MPC8572DS_config}
