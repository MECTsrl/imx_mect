...
#define THE_PERIOD_ms	50  // 21 regs @115,2 kbaud = 8,6 ms 50 // 21 regs @ 38,4 kbaud = 19,8 ms
#define THE_RESPONSE_ms 7   // 15 // response timeout (21regs=14ms 1reg=4ms)
#define THE_BYTE_us     2000// 2000 // 750 // byte timeout
#define THE_SILENCE_us	1750// 1750 // silence delay between requests
#define THE_READALL_ms  (9 + THE_SILENCE_us/1000)    // (20 + THE_SILENCE_us/1000)
#define THE_WRITEONE_ms (5 + THE_SILENCE_us/1000)    // (9 + THE_SILENCE_us/1000)
#define THE_MAXWRITINGS ((THE_PERIOD_ms - THE_READALL_ms) / THE_WRITEONE_ms) // 5,8 // 2,63
#define THE_DEVICE      "/dev/ttySP3"
#define THE_BAUDRATE	115200// 38400
