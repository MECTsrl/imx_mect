...
<html>
<head>
<title>$TARGET_NAME Trends Manager</title>
...
<div id="container">
		<div id="header">
			<table width="100%">
				<tr align="left">
					<td>
						<h1><img src="$LOGO_NAME" style="width:240px;height:136px;float=left;vertical-align:middle;">  $TARGET_NAME Trends Manager</h1>
					</td>
					<td>
EOF
. ./info.cgi
