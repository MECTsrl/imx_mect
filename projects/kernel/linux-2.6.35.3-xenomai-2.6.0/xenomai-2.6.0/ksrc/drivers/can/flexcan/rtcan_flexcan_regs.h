 ...
 *
 * based on linux-2.6.35/drivers/net/can/flexcan/flexcan.h
 * Copyright 2008-2010 Freescale Semiconductor, Inc. All Rights Reserved.
 *
 * based on xenomai-2.6.0/ksrc/drivers/net/can/rtcan_mscan_regs.h
 * Copyright (C) 2006 Wolfgang Grandegger <wg@grandegger.com>
 */

#ifndef __RTCAN_FLEXCAN_REGS_H_
#define __RTCAN_FLEXCAN_REGS_H_

#if LINUX_VERSION_CODE < KERNEL_VERSION(2,6,35)
#error "minimum kernel version 2.6.35"
#endif
