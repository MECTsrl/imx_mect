...
#line 651 "Constants.c"
XS(XS_RPM__Constants_constant)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Constants::constant(name)");
    {
	char*	name = (char *)SvPV(ST(0),PL_na);
	int	RETVAL;
	dXSTARG;
#line 649 "Constants.xs"
    RETVAL = constant(aTHX_ name);
#line 663 "Constants.c"
...
extern "C"
#endif
XS(boot_RPM__Constants)
{
    dXSARGS;
    char* file = __FILE__;

        newXSproto("RPM::Constants::constant", XS_RPM__Constants_constant, file, "$");
    XSRETURN_YES;
}
