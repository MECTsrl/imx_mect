 ...
 * contents of Header.xs. Do not edit this file, edit Header.xs instead.
 *
...
#line 1169 "Header.c"
XS(XS_RPM__Header_TIEHASH)
{
    dXSARGS;
    if (items < 1 || items > 3)
	Perl_croak(aTHX_ "Usage: RPM::Header::TIEHASH(class, source=NULL, flags=0)");
    {
...
XS(XS_RPM__Header_FETCH)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::FETCH(self, key)");
    {
	RPM__Header	self;
	SV*	key = ST(1);
	SV *	RETVAL;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_FETCH: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1179 "Header.xs"
...
XS(XS_RPM__Header_STORE)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: RPM::Header::STORE(self, key, value)");
    {
	RPM__Header	self;
	SV*	key = ST(1);
	SV*	value = ST(2);
	...
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_STORE: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1190 "Header.xs"
...
XS(XS_RPM__Header_DELETE)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::DELETE(self, key)");
    {
	RPM__Header	self;
	SV*	key = ST(1);
	int	RETVAL;
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_DELETE: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1200 "Header.xs"
...
XS(XS_RPM__Header_CLEAR)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::CLEAR(self=NULL)");
    {
	SV*	self;
	int	RETVAL;
	dXSTARG;
...
XS(XS_RPM__Header_EXISTS)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::EXISTS(self, key)");
    {
	RPM__Header	self;
	SV*	key = ST(1);
	bool	RETVAL;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_EXISTS: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1222 "Header.xs"
...
XS(XS_RPM__Header_FIRSTKEY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::FIRSTKEY(self)");
    SP -= items;
    {
	RPM__Header	self;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_FIRSTKEY: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1231 "Header.xs"
    {
...
XS(XS_RPM__Header_NEXTKEY)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::NEXTKEY(self, key=NULL)");
    SP -= items;
    {
	RPM__Header	self;
	SV*	key;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_NEXTKEY: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
...
XS(XS_RPM__Header_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::DESTROY(self)");
    {
	RPM__Header	self;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_DESTROY: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1270 "Header.xs"
...
XS(XS_RPM__Header_size)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::size(self)");
    {
	RPM__Header	self;
	unsigned int	RETVAL;
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_size: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1277 "Header.xs"
...
XS(XS_RPM__Header_tagtype)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::tagtype(self, key)");
    {
	RPM__Header	self;
	SV*	key = ST(1);
	int	RETVAL;
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_tagtype: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1287 "Header.xs"
...
XS(XS_RPM__Header_write)
{
    dXSARGS;
    if (items < 2 || items > 3)
	Perl_croak(aTHX_ "Usage: RPM::Header::write(self, gv, magicp=0)");
    {
	RPM__Header	self;
	SV*	gv = ST(1);
	SV*	magicp;
	...
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_write: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
...
XS(XS_RPM__Header_is_source)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::is_source(self)");
    {
	RPM__Header	self;
	int	RETVAL;
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_is_source: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1316 "Header.xs"
...
XS(XS_RPM__Header_cmpver)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::cmpver(self, other)");
    {
	RPM__Header	self;
	RPM__Header	other;
	int	RETVAL;
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_cmpver: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
...
XS(XS_RPM__Header_NVR)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::NVR(self)");
    SP -= items;
    {
	RPM__Header	self;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_NVR: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1335 "Header.xs"
    {
...
XS(XS_RPM__Header_scalar_tag)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: RPM::Header::scalar_tag(self, tag)");
    {
	SV*	self = ST(0);
	SV*	tag = ST(1);
	int	RETVAL;
...
XS(XS_RPM__Header_source_name)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::source_name(self)");
    {
	RPM__Header	self;
	char *	RETVAL;
	dXSTARG;
        ...
        {
            rpm_error(aTHX_ RPMERR_BADARG,
                      "RPM::Header::rpmhdr_source_name: not a blessed HV reference");
            XSRETURN_UNDEF;
        };
#line 1412 "Header.xs"
...
XS(XS_RPM__Header_constant)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: RPM::Header::constant(name)");
    {
...
XS(boot_RPM__Header)
{
    ...
    char* file = __FILE__;
        ...
        newXSproto("RPM::Header::TIEHASH", XS_RPM__Header_TIEHASH, file, "$;$$");
        newXSproto("RPM::Header::FETCH", XS_RPM__Header_FETCH, file, "$$");
        newXSproto("RPM::Header::STORE", XS_RPM__Header_STORE, file, "$$$");
        newXSproto("RPM::Header::DELETE", XS_RPM__Header_DELETE, file, "$$");
        newXSproto("RPM::Header::CLEAR", XS_RPM__Header_CLEAR, file, "$");
        newXSproto("RPM::Header::EXISTS", XS_RPM__Header_EXISTS, file, "$$");
        newXSproto("RPM::Header::FIRSTKEY", XS_RPM__Header_FIRSTKEY, file, "$");
        newXSproto("RPM::Header::NEXTKEY", XS_RPM__Header_NEXTKEY, file, "$;$");
        newXSproto("RPM::Header::DESTROY", XS_RPM__Header_DESTROY, file, "$");
        newXSproto("RPM::Header::size", XS_RPM__Header_size, file, "$");
        newXSproto("RPM::Header::tagtype", XS_RPM__Header_tagtype, file, "$$");
        newXSproto("RPM::Header::write", XS_RPM__Header_write, file, "$$;$");
        newXSproto("RPM::Header::is_source", XS_RPM__Header_is_source, file, "$");
        newXSproto("RPM::Header::cmpver", XS_RPM__Header_cmpver, file, "$$");
        newXSproto("RPM::Header::NVR", XS_RPM__Header_NVR, file, "$");
        newXSproto("RPM::Header::scalar_tag", XS_RPM__Header_scalar_tag, file, "$$");
        newXSproto("RPM::Header::source_name", XS_RPM__Header_source_name, file, "$");
        newXSproto("RPM::Header::constant", XS_RPM__Header_constant, file, "$");
    XSRETURN_YES;
}
