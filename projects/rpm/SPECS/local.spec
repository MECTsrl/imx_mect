...
%{pfx}/local/flash/data
%{pfx}/local/flash/data/alarms
%{pfx}/local/flash/data/customstore
%{pfx}/local/flash/data/customstore/test.csv
%{pfx}/local/flash/data/customtrend
%{pfx}/local/flash/data/customtrend/trend1.csv
%{pfx}/local/flash/data/recipe
%{pfx}/local/flash/data/recipe/test
%{pfx}/local/flash/data/recipe/test/test1.csv
%{pfx}/local/flash/data/store
%{pfx}/local/flash/data/trends
%{pfx}/local/flash/etc
%{pfx}/local/flash/etc/sysconfig
...
%{pfx}/local/flash/etc/sysconfig/img
...
%{pfx}/local/flash/root/sqldrivers
